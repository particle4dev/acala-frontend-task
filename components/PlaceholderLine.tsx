...
const debug = require('debug')('components:Placeholder:Line');
...
if (process.env.NODE_ENV !== 'production') {
  Line.displayName = 'components__PlaceholderLine';
}
...
export default withStyles(styles, { name: 'components__PlaceholderLine' })(Line);
